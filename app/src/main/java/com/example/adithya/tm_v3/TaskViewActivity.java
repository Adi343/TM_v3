...
public class TaskViewActivity extends AppCompatActivity {
    ...
    ArrayList<Task> array_tasks = new ArrayList<Task>();
    String pName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        projectNameView = (TextView)findViewById(R.id.projectName);
        ...
        final boolean check = bundle.isEmpty();
        if (check != true) {
            String message = bundle.getString("project_name");
            pName = message;
            Toast.makeText(getApplicationContext(), message + "****", Toast.LENGTH_LONG).show();
            projectNameView.setText(message);

        }


        handler1 = new ProjectHelper(TaskViewActivity.this);
        ...
        list_of_tasks.setEmptyView(emptyView);
        //getListData();
        ...
        list_of_tasks.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Task task = new Task(id1, name_of_task, pName, det, dat,priority);
    ...
    private void createTaskDialog3() {
        AlertDialog.Builder alertbox = new AlertDialog.Builder(this,R.style.MyAlertDialogTheme1);
        ...
        dueDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(TaskViewActivity.this,
                            ...
                            public void onDateSet(DatePicker view, int year,
                                ...
                                if(monthOfYear<10){
                                    ...
                                    if(dayOfMonth<10){
                                        ...
                                        date = Integer.toString(year) + "-0" + Integer.toString(monthOfYear) + "-0" + Integer.toString(dayOfMonth);
                                    ...
                                    if(dayOfMonth<10){
                                        ...
                                        date = Integer.toString(year) + "-" + Integer.toString(monthOfYear) + "-0" + Integer.toString(dayOfMonth);
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        if(previous_tasks.contains(input_text)){
                            ...
                            if (input_text.isEmpty()) {
                                ...
                                Task task = new Task(id, input_text, pName, dAt, DAT,priority);
        ...
        alertbox.setNeutralButton("Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                getAdapterCount();
                    ...
                    //Task task = new Task(id,name_of_task,pName,det);
                    final Task task = new Task(id1, name_of_task, pName, det, dat);
                    handler1.deleteTask(id1);
                    refreshListView3();
    ...
    private void showTasksByDate(){
        ...
        cursor = db.rawQuery("SELECT * FROM tasks  WHERE projectName = ? ORDER BY date_in_ms",new String[]{pName});
    ...
    private void sortByPriority(){
        ...
        cursor = db.rawQuery("SELECT * FROM tasks WHERE projectName = ? ORDER BY priority DESC",new String[]{pName});
        TaskCursorAdapter adapter = new TaskCursorAdapter(getApplicationContext(),cursor);
        list_of_tasks.setAdapter(adapter);
